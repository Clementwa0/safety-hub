...
export default function ProductCard ({
  ...
  const handleAddToCart = () => {
    ...
    // TODO: once useCartStore().addToCart returns a result, check
    // result.success here instead of assuming it always succeeds — the
    // store should be the final authority on stock limits, not just this
    // card's `isOutOfStock` check.
