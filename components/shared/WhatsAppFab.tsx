...
import { FaWhatsapp, FaComments, FaRobot, FaTimes } from "react-icons/fa";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 mb-4 w-72 origin-bottom-right"
          >
              ...
              <div className="bg-gradient-to-r from-green-500 to-green-600 px-5 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-100">We respond in minutes</p>
                  </div>
                </div>
              </div>
      ...
      <motion.button
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-green-400 to-green-600 shadow-xl shadow-green-500/30 transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-green-500/40"
        whileTap={{ scale: 0.9 }}
      >
        <motion.div
